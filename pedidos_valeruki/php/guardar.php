<?php
    ...
    $query = mysqli_prepare($conn, "INSERT INTO pedidos (fecha, nombre_dia, dia, mes, cliente, detalle, valor, estado, dot) VALUES (?,?,?,?,?,?,?,?,?)");
    mysqli_stmt_bind_param($query, "ssssssdss", $fecha,$nombre_dia,$dia,$mes_nombre,$cliente,$detalle,$valor,$estado, $dot);
