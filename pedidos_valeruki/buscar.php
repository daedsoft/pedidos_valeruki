...
<body>
    <nav class="nav">
        <div style="display: flex;align-items:center;">            
            <h1 style="margin-left:15px;">VALERUKI / Resultados de busqueda</h1>
        </div>         
    </nav>
    <main>
        <div class="container">
            <?php
                ...
                $query = "SELECT * FROM pedidos WHERE cliente LIKE '%".$buscar."%' OR detalle LIKE '%".$buscar."%' ORDER BY fecha ASC";
                ...
                if ($recs == 0){
                    echo "<h3>No existen pedidos con la busqueda: ".$search."</h3>";
                }   
            ?>
        </div>
        <div class="div-back">
